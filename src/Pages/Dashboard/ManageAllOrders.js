...
const ManageAllOrders = () => {
    const { data: allOrders, isLoading, refetch } = useQuery('allorders', () => fetch('https://plex-tool-server.onrender.com/allorders', {
        method: 'GET',
        headers: {
    ...
    const handleShift = (id) => {
        const url = `https://plex-tool-server.onrender.com/shifted/${id}`
        fetch(url, {
            method: 'PATCH',
            headers: {
                'content-type': 'application/json',
